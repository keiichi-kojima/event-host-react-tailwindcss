      ...
      <div className="flex lg:justify-around lg:w-full xl:justify-between xl:w-[1200px]">
        ...
        <div className="flex items-center">
          <div className="text-center xl:text-right">
            ...
            <div className="block lg:hidden mt-[52px]">
            ...
            <button
              onClick={handleCreateMyEvent}
              className="mt-[52px] mb-[26px] lg:mb-0 text-white rounded-[10px] py-[16px] px-[16px] sm:px-[70px] font-bold sm:text-[20px] bg-gradient-to-r from-primary-purple-normal to-primary-pink"
            >
              🎉 Create my event
            </button>
          </div>
